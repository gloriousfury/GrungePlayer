...
//        btnGoBack.setOnClickListener(this);
        ...
        Bundle getGenreData = getIntent().getExtras();

        if (getGenreData != null) {
            Genre singleGenre = getGenreData.getParcelable(GENRE_ITEM);
            String genre_name = singleGenre.getGenreTitle();
//            String album_art_uri = singleGenre.getAlbumArtUri();
            long genre_id = singleGenre.getId();
...
//            }
            ...
            genreTitle.setText(genre_name);
            collapsingToolbarLayout.setTitle(genre_name);
...
//            Toast.makeText(this, artist_id + " ", Toast.LENGTH_LONG).show();
            ...
            audioList = getPlayists(genre_id);
...
//    }
    ...
    public ArrayList<Audio> getPlayists(long genreId) {
...
//
    ...
    private ServiceConnection serviceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            Toast.makeText(GenreActivity.this, "Service Bound", Toast.LENGTH_SHORT).show();
        }
