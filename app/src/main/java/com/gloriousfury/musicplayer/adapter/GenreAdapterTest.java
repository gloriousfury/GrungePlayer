...
public class GenreAdapterTest extends RecyclerView.Adapter<GenreAdapterTest.ViewHolder> {
    Context context;
    ...
    public GenreAdapterTest(Context context, ArrayList<Audio> song_list) {
